...
async function Home() {
    async function fetchProjects() {
        const response = await fetch("https://api-portifolio-production.up.railway.app/projects");
        const data = await response.json();
        return data;
    }
    const { data: projectsData, token } = await fetchProjects();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0cd71525._.js.map